package id.ac.pelitabangsa.cek_sas;
    ...
    public void UploadImageToServer(){
        ...
        class AsyncTaskUploadClass extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                ...
                progressDialog = ProgressDialog.show(MainActivity.this,"Data Dikirim","Please Wait",false,false);
            }
            ...
            protected String doInBackground(Void... params) {
                ...
                String FinalData = imageProcessClass.ImageHttpRequest("http://192.168.43.169/login/upload-image-to-server.php", HashMapParams);
